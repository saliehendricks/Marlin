...
#define CUSTOM_MACHINE_NAME "Prusa MK1 Printer GG"
 ...
 */
#define TEMP_SENSOR_0 5 //1 SH was here
 ...
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 * //#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 467 } SH
 */
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 2, 25 } //sh: was { 300, 300, 2, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 800, 20, 10000 }
...
#define DEFAULT_ZJERK                  0.4 //0.4 sh
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 5  // Y offset: -front +behind [the nozzle] SH
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0  // Z offset: -below +above  [the nozzle] sh
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION 80 //20
  #define BACK_PROBE_BED_POSITION 230 //190//210 salie
